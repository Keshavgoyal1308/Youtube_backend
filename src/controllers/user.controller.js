...
const getUserChannelProfile = asyncHandler(async(req, res) => {
    ...
    // Fetch the user channel profile with subscribers and channels subscribed to
    const channel = await User.aggregate([
        {
            // Match the user by username it returns an array of objects which is why we use [0] at the end
            $match: {
                username: username?.toLowerCase()
            }
        },
